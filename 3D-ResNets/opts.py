...
def parse_opts():
    ...
    parser.add_argument('--root_path',
                        default='/media/Storage2/xb/Chew/3D-ResNets-PyTorch/data_new_all',
                        type=Path,
    ...
    parser.add_argument('--event_path',
                        default='/media/Storage2/xb/Chew/3D-ResNets-PyTorch/data_new_all/jpgs_event',
                        type=Path,
                        help='Directory path of videos')
    ...
    parser.add_argument('--audio_configs', type=str, help ='configs of audio',	
                    default='/media/Storage2/xb/Chew/RViT-main/AudioClassification-Pytorch/configs/resnet_se.yml')
